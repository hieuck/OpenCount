...
final class MarkerPlacementTests: XCTestCase {
    ...
    func testPlaceMarkerOnEmptySessionCreatesTallyOfOne() async throws {
        ...
        let tallyBefore = session.markers.filter { $0.objectType.id == objectType.id }.count
        ...
        let tallyAfter = session.markers.filter { $0.objectType.id == objectType.id }.count
    ...
    func testEachMarkerPlacementIncrementsCountByOne() async throws {
        ...
        let finalTally = session.markers.filter { $0.objectType.id == objectType.id }.count
    ...
    func testMarkerPlacementDoesNotAffectOtherTypeTallies() async throws {
        ...
        let tallyABefore = session.markers.filter { $0.objectType.id == typeA.id }.count
        let tallyBBefore = session.markers.filter { $0.objectType.id == typeB.id }.count
        let tallyCBefore = session.markers.filter { $0.objectType.id == typeC.id }.count
        ...
        let tallyAAfter = session.markers.filter { $0.objectType.id == typeA.id }.count
        let tallyBAfter = session.markers.filter { $0.objectType.id == typeB.id }.count
        let tallyCAfter = session.markers.filter { $0.objectType.id == typeC.id }.count
